  ...
  return (
    ...
    >
      <Container as={Stack} maxW={"6xl"} py={10}>
        <SimpleGrid
          templateColumns={{ sm: "1fr 2fr", md: "2fr 1fr 1fr 2fr" }}
          spacing={8}
        >
          <Stack spacing={6}>
            {/* <Box>
          ...
          <Stack align={"flex-start"}>
            <ListHeader color={"green"}>ONLINE SHOPPING</ListHeader>
            <Link href={"#"}>Men’s T-Shirts</Link>
            <Link href={"#"}>Women’s Wear</Link>
            <Link href={"#"}>Winter Collections</Link>
            <Link href={"#"}>Hooded T-Shirts</Link>
            <Link href={"#"}>Streetwear Collections</Link>
          </Stack>
          <Stack align={"flex-start"}>
            <ListHeader>CUSTOMER POLICIE</ListHeader>
